...
over a set of numbers to calculate the factors and Prime numbers and Composite numbers
...
This is a limitation to the number of recursive levels which around 952 levels
"""
